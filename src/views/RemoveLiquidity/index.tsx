...
import { Currency, currencyEquals, ETHER, Percent, WETH } from '@doodaswap/sdk'
import { Button, Text, AddIcon, ArrowDownIcon, CardBody, Slider, Box, Flex, useModal } from '@doodaswap/new-uikit'
